...
-module(nkserver_ot_of_lexer).

-export([string/1,string/2,token/2,token/3,tokens/2,tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("/Users/carlosj/Desarrollo/Public/nkserver_ot/src/nkserver_ot_of_lexer.xrl", 67).
...
-file("/Users/carlosj/Desarrollo/Public/nkserver_ot/src/nkserver_ot_of_lexer.erl", 317).
yystate() -> 45.
...
yystate(47, [10|Ics], Line, Tlen, _, _) ->
    yystate(47, Ics, Line+1, Tlen+1, 13, Tlen);
...
yystate(45, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(16, Ics, Line, Tlen+1, Action, Alen);
yystate(45, [C|Ics], Line, Tlen, Action, Alen) when C >= 101, C =< 114 ->
    yystate(16, Ics, Line, Tlen+1, Action, Alen);
yystate(45, [C|Ics], Line, Tlen, Action, Alen) when C >= 116, C =< 122 ->
    yystate(16, Ics, Line, Tlen+1, Action, Alen);
...
yystate(42, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 109 ->
    yystate(16, Ics, Line, Tlen+1, 7, Tlen);
yystate(42, [C|Ics], Line, Tlen, _, _) when C >= 111, C =< 116 ->
    yystate(16, Ics, Line, Tlen+1, 7, Tlen);
yystate(42, [C|Ics], Line, Tlen, _, _) when C >= 118, C =< 122 ->
    yystate(16, Ics, Line, Tlen+1, 7, Tlen);
yystate(42, Ics, Line, Tlen, _, _) ->
    {7,Tlen,Ics,Line,42};
yystate(41, [67|Ics], Line, Tlen, Action, Alen) ->
...
yystate(35, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 33 ->
    yystate(43, Ics, Line, Tlen+1, Action, Alen);
yystate(35, [C|Ics], Line, Tlen, Action, Alen) when C >= 35, C =< 45 ->
    yystate(43, Ics, Line, Tlen+1, Action, Alen);
yystate(35, [C|Ics], Line, Tlen, Action, Alen) when C >= 47 ->
    yystate(43, Ics, Line, Tlen+1, Action, Alen);
...
yystate(31, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(31, Ics, Line, Tlen+1, 13, Tlen);
yystate(31, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 32 ->
    yystate(31, Ics, Line, Tlen+1, 13, Tlen);
yystate(31, [C|Ics], Line, Tlen, _, _) when C >= 33, C =< 36 ->
    yystate(31, Ics, Line, Tlen+1, 13, Tlen);
yystate(31, [C|Ics], Line, Tlen, _, _) when C >= 38 ->
    yystate(31, Ics, Line, Tlen+1, 13, Tlen);
...
yystate(27, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 38 ->
    yystate(27, Ics, Line, Tlen+1, Action, Alen);
yystate(27, [C|Ics], Line, Tlen, Action, Alen) when C >= 40, C =< 45 ->
    yystate(27, Ics, Line, Tlen+1, Action, Alen);
yystate(27, [C|Ics], Line, Tlen, Action, Alen) when C >= 47 ->
    yystate(27, Ics, Line, Tlen+1, Action, Alen);
...
yystate(6, Ics, Line, Tlen, _, _) ->
    {4,Tlen,Ics,Line,6};
yystate(5, [107|Ics], Line, Tlen, _, _) ->
...
yystate(5, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 100 ->
    yystate(16, Ics, Line, Tlen+1, 7, Tlen);
yystate(5, [C|Ics], Line, Tlen, _, _) when C >= 102, C =< 106 ->
    yystate(16, Ics, Line, Tlen+1, 7, Tlen);
yystate(5, [C|Ics], Line, Tlen, _, _) when C >= 108, C =< 122 ->
    yystate(16, Ics, Line, Tlen+1, 7, Tlen);
...
-file("/Users/carlosj/Desarrollo/Public/nkserver_ot/src/nkserver_ot_of_lexer.xrl", 46).
yyaction_0(TokenLine) ->
     { token, { comment, TokenLine } } .

-compile({inline,yyaction_1/1}).
-file("/Users/carlosj/Desarrollo/Public/nkserver_ot/src/nkserver_ot_of_lexer.xrl", 47).
yyaction_1(TokenLine) ->
     { token, { kw_arrow, TokenLine } } .

-compile({inline,yyaction_2/1}).
-file("/Users/carlosj/Desarrollo/Public/nkserver_ot/src/nkserver_ot_of_lexer.xrl", 48).
yyaction_2(TokenLine) ->
     { token, { kw_send, TokenLine } } .

-compile({inline,yyaction_3/1}).
-file("/Users/carlosj/Desarrollo/Public/nkserver_ot/src/nkserver_ot_of_lexer.xrl", 49).
yyaction_3(TokenLine) ->
     { token, { kw_drop, TokenLine } } .

-compile({inline,yyaction_4/1}).
-file("/Users/carlosj/Desarrollo/Public/nkserver_ot/src/nkserver_ot_of_lexer.xrl", 50).
yyaction_4(TokenLine) ->
     { token, { kw_skip, TokenLine } } .

-compile({inline,yyaction_5/1}).
-file("/Users/carlosj/Desarrollo/Public/nkserver_ot/src/nkserver_ot_of_lexer.xrl", 51).
yyaction_5(TokenLine) ->
     { token, { kw_cont, TokenLine } } .

-compile({inline,yyaction_6/1}).
-file("/Users/carlosj/Desarrollo/Public/nkserver_ot/src/nkserver_ot_of_lexer.xrl", 52).
yyaction_6(TokenLine) ->
     { token, { kw_count, TokenLine } } .

-compile({inline,yyaction_7/2}).
-file("/Users/carlosj/Desarrollo/Public/nkserver_ot/src/nkserver_ot_of_lexer.xrl", 53).
yyaction_7(TokenChars, TokenLine) ->
     { token, { kw, TokenLine, TokenChars } } .

-compile({inline,yyaction_8/2}).
-file("/Users/carlosj/Desarrollo/Public/nkserver_ot/src/nkserver_ot_of_lexer.xrl", 54).
yyaction_8(TokenChars, TokenLine) ->
     { token, { cmp, TokenLine, a (TokenChars) } } .

-compile({inline,yyaction_9/2}).
-file("/Users/carlosj/Desarrollo/Public/nkserver_ot/src/nkserver_ot_of_lexer.xrl", 55).
yyaction_9(TokenChars, TokenLine) ->
     { token, { num, TokenLine, i (TokenChars) } } .

-compile({inline,yyaction_10/3}).
-file("/Users/carlosj/Desarrollo/Public/nkserver_ot/src/nkserver_ot_of_lexer.xrl", 56).
yyaction_10(TokenChars, TokenLen, TokenLine) ->
     S = strip (TokenChars, TokenLen),
     { token, { str, TokenLine, S } } .

-compile({inline,yyaction_11/3}).
-file("/Users/carlosj/Desarrollo/Public/nkserver_ot/src/nkserver_ot_of_lexer.xrl", 58).
yyaction_11(TokenChars, TokenLen, TokenLine) ->
     S = strip (TokenChars, TokenLen),
     { token, { str, TokenLine, S } } .

-compile({inline,yyaction_12/2}).
-file("/Users/carlosj/Desarrollo/Public/nkserver_ot/src/nkserver_ot_of_lexer.xrl", 61).
yyaction_12(TokenChars, TokenLine) ->
     { token, { a (TokenChars), TokenLine } } .

-compile({inline,yyaction_13/0}).
-file("/Users/carlosj/Desarrollo/Public/nkserver_ot/src/nkserver_ot_of_lexer.xrl", 62).
yyaction_13() ->
     skip_token .
